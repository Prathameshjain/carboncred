...
const Marketplace = () => {
  ...
  return (
      ...
      {/* Header */}
      <header className="sticky top-0 z-50 backdrop-blur-sm bg-gradient-to-br from-white to-green-50 border-b border-gray-200/60">
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-4">
              <Button
                ...
                size="icon"
                onClick={handleBack}
                className="flex rounded hover:bg-gray-200"
              >
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col items-start">
                  <h1 className="text-xl font-bold text-black">Carbon Credit Marketplace</h1>
                  <p className="text-xs text-slate-800">Browse and purchase verified credits</p>
                </div>
              </div>
            </div>
            <button 
      ...
      <div className="sticky top-[64px] h-[1px] bg-gradient-to-r from-transparent via-gray-300 to-transparent z-40"></div>
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="flex flex-col md:flex-row gap-4 mb-8">
          ...
          <Button variant="outline" className="gap-2 rounded border-slate-700 text-slate-700 hover:bg-emerald-500 hover:text-white">
            ...
            <CardContent className="pt-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-emerald-500">$18.50</p>
                </div>
            ...
            >
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-slate-700">Available Credits</span>
                    <span className="text-lg font-bold text-slate-900">{project.credits.toLocaleString()}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-slate-700">Price per Credit</span>
                    <span className="text-lg font-bold text-emerald-400">${project.price}</span>
                  </div>
                  <div className="flex justify-between items-center">
        ...
        <Dialog open={openDialog} onOpenChange={setOpenDialog}>
          <DialogContent className=" backdrop-blur-lg text-white border max-w-md">
            <DialogHeader>
            ...
            {selectedProject && (
              <div className="space-y-4 mt-4">
                ...
                <div className="flex flex-col gap-2 mt-4">
                  <label className="text-slate-300 text-sm">Enter quantity</label>
                  <input
                    type="number"
                    min="1"
                    className="bg-white border border-gray-300 rounded px-3 py-2 text-white"
                  />
                </div>

                <Button className="w-full rounded bg-emerald-600 hover:bg-emerald-700 text-white mt-4">
                  Confirm Purchase
                </Button>
              </div>
            )}
